...
# Сброс потраченных денег у пользователей
...
def register_user_route():
    ...
    # Здесь нужно добавить функцию `register_user` и её реализацию
...
def gpt(question):
    ...
    data = {
        ...
        "messages": [
            {
                "role": "system",
                "text": f"напиши достопримечательности в этом городе(пиши кратко без объяснений, просто цифра точка достопримечательность): {question}"
            }
        ]
    }
