...
const teamContacts = [
  { name: 'Сильчев Антон', telegram: '@pivo_rearm_pivo_rearm_pivo' },
  { name: 'Будыгин Тимофей', telegram: '@Timofei_Bud' },
  { name: 'Козлов Сергей', telegram: '@LilTeck1337' },
  { name: 'Тарасов Григорий', telegram: '@Stopnadzor' },
  { name: 'Емельянов Дмитрий', telegram: '@neverminderrr' },
];
